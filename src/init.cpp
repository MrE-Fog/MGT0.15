...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/magnetocoin-project/magnetocoin>";
    const std::string URL_WEBSITE = "<https://magnetocoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Magnetocoin version %s\n", FormatFullVersion());
}
