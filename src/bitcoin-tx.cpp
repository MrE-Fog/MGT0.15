...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s magnetocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  magnetocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded magnetocoin transaction") + "\n" +
              "  magnetocoin-tx [options] -create [commands]   " + _("Create hex-encoded magnetocoin transaction") + "\n" +
              "\n";
