...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.magnetocoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.magnetocointools.com", true);
        vSeeds.emplace_back("dnsseed.magnetocoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.magnetocointools.com", true);
        vSeeds.emplace_back("seed-b.magnetocoin.loshan.co.uk", true);
